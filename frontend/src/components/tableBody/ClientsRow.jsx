...
const ClientRow = ({ index, client }) => {
  ...
  const { data, isSuccess:isS } = useGetClientByIdQuery(client.id)
 ...
 React.useEffect(() => {
    ...
    if (client) {
      Swal.fire({
        ...
        html: `
              ...
              <p> ${client.es_fijo ?`Género Favorito: ${data.genero_favorito}` : ""}</p>`,               
               focusConfirm: false,
               confirmButtonText: `<svg xmlns="http://www.w3.org/2000/svg" height="24" fill="white" viewBox="0 -960 960 960" width="24"><path d="M640-520v-80h240v80H640Zm-280 40q-66 0-113-47t-47-113q0-66 47-113t113-47q66 0 113 47t47 113q0 66-47 113t-113 47ZM40-160v-112q0-34 17.5-62.5T104-378q62-31 126-46.5T360-440q66 0 130 15.5T616-378q29 15 46.5 43.5T680-272v112H40Zm80-80h480v-32q0-11-5.5-20T580-306q-54-27-109-40.5T360-360q-56 0-111 13.5T140-306q-9 5-14.5 14t-5.5 20v32Zm240-320q33 0 56.5-23.5T440-640q0-33-23.5-56.5T360-720q-33 0-56.5 23.5T280-640q0 33 23.5 56.5T360-560Zm0-80Zm0 400Z"/></svg>`,
               confirmButtonColor: "red",
               showCloseButton: true,
               showDenyButton: true,
  ...
  return (
    <tr className="border-b text-gray-500 hover:bg-gray-50" onClick={()=>handleInfo(client)}>
      <td className="py-3 text-left px-4 flex flex-row items-center">{`${client.nombre}`}{client.es_fijo && 
      
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
           className="bi bi-person-heart ml-2" viewBox="0 0 16 16">
        <path
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
             className="bi bi-person-fill-slash ml-2" viewBox="0 0 16 16">
          <path
    ...
    {!client.es_fijo && !client.invalidado &&
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
               className="bi bi-person-fill ml-2"
               viewBox="0 0 16 16">
      ...
      <td className="text-left">{client.direccion}</td>
    </tr>
  );
};
